defmodule DoneManagerWeb.Layouts do
  @moduledoc """
  ...
  def app(assigns) do
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <a
          href={DoneManagerWeb.HomeRedirector.path(@current_scope)}
      ...
      <div class="flex-none">
        <ul class="flex flex-column px-1 space-x-4 items-center">
          ...
          <%= if @current_scope do %>
            ...
            <li>
              <.link href={~p"/auth/logout"} method="delete" class="btn btn-primary">Log out</.link>
            </li>
          <% else %>
            <li>
              <.link href={~p"/auth/auth0"} class="btn btn-primary">Log in</.link>
            </li>
          <% end %>
        </ul>
      </div>
